...
for bp in blueprints[1:2]:
    ...
    while len(jono) > 0:
        ...
        nore = ore_tee(ore)
        nclay = ore_tee(clay)
        nobsidian = ore_tee(obsidian)
        ngeode = ore_tee(geode)

        nval = (nore,nclay,nobsidian,ngeode)
